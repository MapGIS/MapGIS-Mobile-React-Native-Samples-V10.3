...
import {View, ToastAndroid, TouchableOpacity, Text, StyleSheet, FlatList} from "react-native";
...
export default class MapIGServerQuery extends Component {
    ...
    _featureQuery = async () => {
        ...
        let query = await featureQuery.createObjByIGSDoc(IGSERVER_BASE_URL, "WuHan", 0, 11);
