...
import {View, ToastAndroid, TouchableOpacity, Text, DeviceEventEmitter} from "react-native";
...
import {
    ...
    PointF,
    QueryBound,
    FeatureQuery, GraphicPoint,SpaAnalysis,
...
export default class MapGraphicPoint extends Component {
    ...
    componentDidMount() {
        DeviceEventEmitter.addListener("com.mapgis.RN.Mapview.LoadMapListener_Finish", async res => {
            ...
            {
                let R = new Rect();
                let mapRange = await R.createObj(12721012.835149, 3545154.582956, 12737898.505747, 3571796.418788);
